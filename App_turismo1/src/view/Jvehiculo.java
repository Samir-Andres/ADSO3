...
public class Jvehiculo extends JFrame {
	...
	public Jvehiculo() {
		...
		lblNewLabel_6.setBounds(311, 102, 70, 14);
		contentPane.add(lblNewLabel_6);
		
		txtcategoria = new JTextField();
		txtcategoria.setBounds(295, 127, 86, 20);
		contentPane.add(txtcategoria);
		txtcategoria.setColumns(10);
		
		txtidtipotransporte = new JTextField();
		txtidtipotransporte.setBounds(32, 198, 86, 20);
		...
		lblNewLabel_7.setBounds(30, 173, 115, 14);
		...
		btnRegistrar.setBounds(29, 244, 54, 57);
		contentPane.add(btnRegistrar);
		
		btnLimpiar = new JButton("Limpiar");
		btnLimpiar.setFont(new Font("Serif", Font.BOLD, 13));
		btnLimpiar.setBounds(175, 314, 89, 23);
		...
		lblNewLabel_7_1.setBounds(175, 173, 115, 14);
		...
		btnNewButton_1.setBounds(229, 244, 59, 57);
		...
		BTNUPDATE.setBounds(322, 244, 59, 57);
